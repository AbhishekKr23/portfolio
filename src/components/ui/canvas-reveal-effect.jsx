    ...
    for (const key in uniforms) {
      ...
      switch (u.type) {
        ...
        case "uniform1fv":
          ...
          break;
        case "uniform2f":
          prepared[key] = { value: new THREE.Vector2().fromArray(u.value) };
          break;
        case "uniform3f":
          prepared[key] = { value: new THREE.Vector3().fromArray(u.value) };
          break;
        case "uniform3fv":
          prepared[key] = {
          ...
          break;
        default:
          console.error(`Unknown uniform type for ${key}`);
          break;
      }
    }
...
const Shader = ({ source, uniforms, maxFps }) => {
  return (
